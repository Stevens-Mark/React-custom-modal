...
var _default = colors; // Define the theme colours for the modal
// (set your colours here or leave values empty '' for default theme)
// light mode 

exports.default = _default;
const lightTheme = {
  pageBg: "".concat(colors.lightOpacity),
  modalBg: "".concat(colors.primary),
  modalTxt: "".concat(colors.tertiary),
  modalBorder: "solid 2px ".concat(colors.secondary),
  modalBtnColor: "".concat(colors.tertiary),
  modalShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px'
}; // dark mode

exports.lightTheme = lightTheme;
const darkTheme = {
  pageBg: "".concat(colors.lightestNavyOpacity),
  modalBg: "".concat(colors.navy),
  modalTxt: "".concat(colors.lightGreen),
  modalBorder: "solid 2px ".concat(colors.chromeBlue),
  modalBtnColor: "".concat(colors.lightGreen),
  modalShadow: 'rgba(0, 0, 0, 1) 0px 5px 15px' // modalRadius: "false",
